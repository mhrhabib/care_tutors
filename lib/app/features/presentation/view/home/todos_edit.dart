...
import 'package:care_tutors/app/features/presentation/view/home/widgets/extensions.dart';
...
class _TodosEditState extends ConsumerState<TodosEdit> {
  ...
  late final model = ref.read(todosListState.notifier);
  late final state = ref.read(todosListState);
          ...
          if (widget.todoId != null)
            IconButton(
              ...
              onPressed: () async {
                ...
                if (confirmed == true) {
                  var x =state.firstWhere((element) => element.id == widget.todoId);
                  print(widget.todoId);
                    model.delete(x.id!);
